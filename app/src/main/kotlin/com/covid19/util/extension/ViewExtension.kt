...
/*fun TextView.bold() {
    typeface = ResourcesCompat.getFont(context, R.font.proxima_nova_bold)
}

fun TextView.normal() {
    typeface = ResourcesCompat.getFont(context, R.font.proxima_nova_regular)
}

fun TextView.light() {
    typeface = ResourcesCompat.getFont(context, R.font.proxima_nova_light)
}

fun TextView.semiBold() {
    typeface = ResourcesCompat.getFont(context, R.font.proxima_nova_semibold)
}
